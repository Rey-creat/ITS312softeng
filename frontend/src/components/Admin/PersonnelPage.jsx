...
const Personnel = () => {
  ...
  const handleApprove = () => {
    ...
    alert("Request Approved by Personnel in Charge");
  };

  const handleReject = () => {
    setDecision("rejected");
    alert("Request Rejected by Personnel in Charge");
  };
  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="flex-1 p-6 bg-gray-100 overflow-y-auto">
        <h1 className="text-2xl font-bold mb-4">Personnel in Charge</h1>
        <p className="mb-4 text-gray-700">
          Review requests and check the details as the personnel in charge.
        </p>
