...
const VPFGS = () => {
  ...
  const handleApprove = () => {
    ...
    alert("Request Approved by VPFGS");
  };

  const handleReject = () => {
    setDecision("rejected");
    alert("Request Rejected by VPFGS");
  };
  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="flex-1 p-6 bg-gray-100 overflow-y-auto">
        <h1 className="text-2xl font-bold mb-4">VPFGS</h1>
        <p className="mb-4 text-gray-700">
          Review and endorse requests forwarded to the VPFGS.
        </p>
